    ...
    <div v-else>
      ...
      <div class="ui grid">
        <div class="sixteen wide computer column sixteen wide mobile column">
          ...
          >
            <div
              class="eight wide computer column sixteen wide mobile column ui fluid image"
            ...
            >
              <div class="ui mini images">
                <img
                  ...
                  :alt="ingredient.name"
                  :title="ingredient.unit + ' ' + ingredient.name"
            ...
            <div class="eight wide computer column sixteen wide mobile column">
              ...
              <div class="ui grid">
                <div
                  class="four wide computer column sixteen wide mobile column"
                >
                  <Claps />
                </div>
                <div
                ...
                >
                  <div
                    class="ui tbb fluid mini circular button"
                ...
                >
                  <div
                    class="ui icon tbb fluid mini circular button"
