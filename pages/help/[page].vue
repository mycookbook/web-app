        ...
        <div class="ui grid">
            <div class="three wide computer column sixteen wide tablet column mobile hidden">
                ...
                <div class="ui vertical fluid menu">
                    <a class="item" href="/help/query-syntax">
                    ...
                    <a class="item" href="/help/templates">
...
import { QuerySyntax, Templates } from '#components'
        ...
        search(e) {
            if (e.which == 13) {
                if (e.target.placeholder == 'Advanced Search') {
                    this.$router.replace({ name: 'search', query: { q: this.advQuery } })
                } else {
